...
The system follows a 4-tier approach – Presentation, Application Logic, Service and Data Management Layer. </td>
  ...
  <tr>
    ...
    <td class="tg-yw4l"><a href="http://webstrar64.fulton.asu.edu/page9/AllTickets.aspx">AllTickets.aspx</a></td>
    <td class="tg-yw4l">A service to check all available flight from the local text file</td>
    <td class="tg-yw4l">Require local text file to store the tickets</td>
  </tr>  
    <tr>
    <th class="tg-yw4l" colspan="5"><strong>MEMBER PAGE</strong></br>Test Credentials:(member@gmail.com,member123)</th>
  </tr>  
     <tr>
    <td class="tg-yw4l">Prashanna Raghavan</td>
    ...
    <td class="tg-yw4l"><a href="http://webstrar64.fulton.asu.edu/page9/Tickets.aspx">Tickets.aspx</a></td>
  ...
  <tr>
    ...
    <td class="tg-yw4l"><a href="http://webstrar64.fulton.asu.edu/page9/Reserve.aspx">Reserve.aspx</a></td>
    ...
    <tr>
    <th class="tg-yw4l" colspan="5"><strong>STAFF PAGE(SUPPORT)</strong></br>Test Credentials:(support@gmail.com,support123)</th>
  </tr>
  <tr>
    <td class="tg-yw4l">Prashanna Raghavan</td>
    ...
    <td class="tg-yw4l"><a href="http://webstrar64.fulton.asu.edu/page9/Validate.aspx">Validate.aspx</a></td>
    ...
    <tr>
    <th class="tg-yw4l" colspan="5"><strong>STAFF PAGE(ADMIN)</strong></br>Test Credentials:(admin@gmail.com,admin123)</th>
  </tr>
  <tr>
    <td class="tg-yw4l">Prashanna Raghavan</td>
    <td class="tg-yw4l">Airline Reservation System : Cancel Tickets </br> Input : string confirmationNumber </br> Output : Cancel status </td>
    <td class="tg-yw4l"><a href="http://webstrar64.fulton.asu.edu/page9/Cancel.aspx">Cancel.aspx</a></td>
