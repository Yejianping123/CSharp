...
public partial class Reserve : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (httpCookie == null || httpCookie["username"] == "") { Response.Redirect("Unauthorized.aspx"); }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        HttpCookie httpCookie = new HttpCookie("myCookieId");
        TextBox1.Text = httpCookie["username"];
